    ...
    <div className="bg-[#0c1f4a] min-h-screen flex flex-col justify-center items-center text-white">
      <div className="w-full max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-16 bg-[#111a34] p-8 rounded-md">
          ...
          <div>
            <p className="text-sm">
            Ventures Federal Trading Commission (V-FTC) is committed to protecting the privacy and security of our users' personal information. This Privacy Policy outlines our practices regarding the collection, use, and disclosure of personal information when you use our services.            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
            <h2 className="text-xl font-bold mb-2">With Regulatory and Legal Authorities</h2>
            <p className="text-sm">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm">
            You can opt-out of receiving marketing communications from us by following the unsubscribe instructions included in our emails or by updating your preferences in your account settings.            </p>
          </div>

          <div className="mb-6">
            <h2 className="text-xl font-bold mb-2">Changes to This Privacy Policy</h2>
            <p className="text-sm">
            We may update this Privacy Policy from time to time to reflect changes in our practices or legal requirements. We will notify you of any material changes by posting the updated policy on our platform and, where appropriate, by sending you a notification.            </p>
          </div>

          <div className="mb-6">
            <h2 className="text-xl font-bold mb-2">Contact Us</h2>
            <p className="text-sm">
            If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at contact information given below.             </p>
          </div>
