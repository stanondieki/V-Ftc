...
>
  <div className="bg-opacity-70 p-6 rounded-md" style={{ textAlign: 'center' }}>
    <h1 className="text-5xl font-bold mb-6">Forex Investment Service</h1>
    <p className="text-lg font-medium" style={{ maxWidth: '700px' }}>
      Our Forex Investment Service offers clients an opportunity to participate
      in the dynamic and potentially lucrative foreign exchange market. By leveraging our
      expertise, advanced trading technologies, and comprehensive market analysis,
      we provide tailored investment strategies to maximize returns while managing risks.
    </p>
  </div>
</div>
